...
function layoutCells(node, rect, wall) {
	...
	if (children.length === 0) {return [{rect, customization: node.customization}];}

	const isAlongX = node.splitType === 'vertical'; // Vertical separators => children side by side in X
